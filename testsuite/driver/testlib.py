...
def test_common_work(watcher, name, opts, func, args):
    try:
        ...
        if func == compile or func == multimod_compile:
            ...
            if getTestOpts().only_ways != ['normal']:
                ...
                framework_fail(name, 'whole-test',
                               '''
                               this test is neither a run-time nor a
                               compile-time test yet and consequently can only
                               run in the 'normal' testsuite way. However, it is
                               configured to run only in the %s ways.
